...
class PublishConfig extends Command
{
    ...
    private function message(): array
    {
        return [
            ...
            "|--------------------------------------------------------------------------",
            "|",
            "| This config file can be seen as overwhelmingly long, but don't worry;",
            "| you probably won't need to deal with most parts. But before everything",
            "| else, some settings may need your attention.",
            "| ",
            "| • apps",
            "| • identity",
            "| • repository",
